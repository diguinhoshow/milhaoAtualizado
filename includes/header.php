...
<html lang="en">
<head>
	<title>Área Discente - Milhão na Mesa</title>
	<!-- for-mobile-apps -->
...
<body>
	...
	<header class="py-3">
		<div class="container">
			<div id="logo">
				<h1> <a href="../index.html"><span class="fa fa-stethoscope" aria-hidden="true"></span> Um milhão na mesa</a></h1>
			</div>
			<!-- nav -->
			<nav class="d-lg-flex">
				...
				<ul class="menu mt-2 ml-auto">
					...
					<li class=""><a href="../gallery.html">Ranking</a></li>

...
<body>
	...
	$result = mysqli_query($conexao, "SELECT id, assunto FROM questionario WHERE email_docente = '$emaild'");
								...
								<div class="col-md-12">
									...
									<form method="POST">
										<div style="text-align: center; font-weight: bold;">
											Nome do Quiz<br>
											<?php echo $linhas['assunto']; ?> 
										</div>
									</form>
									<br>

									<div class="submit-buttons">
										<a href="editar_questao.php?&id=<?php echo $linhas['id'];?>">		
											<button type="submit" class="btn" style="background-color: green; color: white; margin-left: -12% ">Editar</button>
										</a>
									</div>


									<div class="submit-buttons">
										<a href="deletar_questionario.php?&id=<?php echo $linhas['id'];?>">
											<button class="btn" style="background-color: red; color: white; margin-left: 21%; margin-top: -28%">Apagar</button>
										</a>
									</div>

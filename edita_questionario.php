...
<body>
	...
	$resultado = mysqli_query($conexao, "SELECT id, enuciado, assunto, alternativa1, alternativa2, alternativa3, alternativa4, alternativa5 FROM questao WHERE assunto='$assunto'");

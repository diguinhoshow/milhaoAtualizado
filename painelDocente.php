...
<section class="appointment text-center py-5">
	<div class="container py-sm-3">
		<h4>Um milhão na mesa</h4>
		<a href="cadastroQuestionario.php">Cadastrar Questionário</a>
		<a href="editaQuestionario.php">Editar Questionário</a>
	</div>

	<div class="container py-sm-3">
		<a href="iniciarJogo.php">Iniciar Jogo</a>
	</div>
...
<section class="appointment text-center py-5">
	<div class="container py-sm-3" style="margin-bottom: 3%">

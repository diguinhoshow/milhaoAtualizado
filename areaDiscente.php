					...
					<div class="comment-top">
						...
						<div class="comment-bottom">
							<form action="sala.php" method="POST">
								...
								<input class="form-control" type="text" name="codigo_acesso" placeholder="Código de acesso" required=""><br>

								<button type="submit" class="btn btn-primary submit">Começar</button>

								<a href="index.html" class="btn btn-banner1 my-sm-3 mb-3">Voltar</a>

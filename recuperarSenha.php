			...
			<div class="row inner-sec-w3ls-agileinfo">
				...
				<div class="col-lg-8 left-blog-info text-left">
					<div class="comment-top">
						<h4>Insira o e-mail para recuperação</h4>
						<div class="comment-bottom">

							<form action="loginDocente.php" method="post">
								<input class="form-control" type="email" name="email" placeholder="E-mail" required=""> <br>

								<button type="submit" class="btn btn-primary submit" onclick="return recuperarSenha()" >Enviar </button>
